...
* the **attendance**, 
* the **exposure received by the conference**,
* the **content** of the conference,
* the **2019 speakers feedback**,
* the **improvements made in 2019** following the feedback of the 2018 attendees, 
* and finally, the **feedback from 2019 attendees**.
...
<div style="border-left: 5px solid green; padding-left: 10px"> <h2>3. The conference</h2></div>
...
<div style="border-left: 5px solid green; padding-left: 10px"> <h2>4. 2019 speakers Feedback</h2></div>
You will find there the feedbacks from some of the speakers of the 2019 edition.
...
<div style="border-left: 5px solid green; padding-left: 10px"> <h2>5. 2019 improvements after 2018 attendees feedback</h2></div>
...
* **Practical side:**
  ...
  **OK.**
  * **Rump session.** Improve rump session fluidity, try to get a maximum of slides on the same machine → Everything has been fluid due to the majority of the slides decks were already on the presentation laptop.<br>
  **OK.**
  ...
  **OK.**
  * **Pauses.** Improve the pauses content. → We have changed the provider (no choice). It was less expensive but the content has to be improved.<br>
  **To be improved.**
  ...
  **In progress.**
  * **Lunch.** *Before each day mid-day break, explain how to find the restaurants location → Last year, the only option was a 5 to 10min walk to Pierre Mauroy stadium to reach restaurant and take away food stores. This year, we added 2 food trucks** to this first option.<br>
  **OK.**
  ...
  **OK.**
  * **Badge<br>.** Have a way to prevent badge flipping / allow to add some information on them (personal information like proj  **ect**, twitter handle, company, languages spoken etc) → The badge design provided good answers to these problems. But we have to improve the solidity of the 2 attachment points.<br>
  **~OK.**
...
source : sondage avec 83 participants
...
source: survey with 83 participants (for 185 attendees)
